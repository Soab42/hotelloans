...
import Hope from "../../template/images/causes/poor-child-landfill-looks-forward-with-hope.jpg";
import Outdoors from "../../template/images/causes/african-woman-pouring-water-recipient-outdoors.jpg";
    ...
    <section className="section-padding" id="section_3">
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
            <div className="custom-block-wrap">
              <img src={Hope} className="custom-block-image img-fluid" alt="" />
