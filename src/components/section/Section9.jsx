...
import Donation from "../../template/images/news/medium-shot-volunteers-with-clothing-donations.jpg";
import FoodStuff from "../../template/images/news/medium-shot-people-collecting-foodstuff.jpg";
import Togather from "../../template/images/news/close-up-happy-people-working-together.jpg";
// import Organize from "../../template/images/news/close-up-volunteer-oganizing-stuff-donation";
import Aid from "../../template/images/news/africa-humanitarian-aid-doctor.jpg";
            ...
            <div className="news-block">
              <div className="news-block-top">
                <a href="news-detail.html">
                  <img src={Donation} className="news-image img-fluid" alt="" />
                </a>
          ...
          <div className="col-lg-4 col-12 mx-auto">
            ...
            <div className="news-block news-block-two-col d-flex mt-4">
              <div className="news-block-two-col-image-wrap">
                <a href="news-detail.html">
                  <img src={Aid} className="news-image img-fluid" alt="" />
                </a>
              </div>
            ...
            <div className="news-block news-block-two-col d-flex mt-4">
              <div className="news-block-two-col-image-wrap">
                <a href="news-detail.html">
                  <img src={Togather} className="news-image img-fluid" alt="" />
                </a>
              </div>
